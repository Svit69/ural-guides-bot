...
from src.guides import chekists_idol_posts as idol
from src.guides import chekists_final_posts as final, chekists_library_posts as library
...
class ChekistsPostCatalog:
    def get_posts(self) -> dict[int, str]:
        return {
            ...
            post.CHEKISTS_THIRTEENTH_POST_NUMBER: art.DEFAULT_CHEKISTS_THIRTEENTH_POST,
            post.CHEKISTS_FOURTEENTH_POST_NUMBER: extra.DEFAULT_CHEKISTS_FOURTEENTH_POST,
            post.CHEKISTS_FIFTEENTH_POST_NUMBER: extra.DEFAULT_CHEKISTS_FIFTEENTH_POST,
            post.CHEKISTS_SIXTEENTH_POST_NUMBER: extra.DEFAULT_CHEKISTS_SIXTEENTH_POST,
            post.CHEKISTS_SEVENTEENTH_POST_NUMBER: extra.DEFAULT_CHEKISTS_SEVENTEENTH_POST,
            post.CHEKISTS_EIGHTEENTH_POST_NUMBER: extra.DEFAULT_CHEKISTS_EIGHTEENTH_POST,
            post.CHEKISTS_NINETEENTH_POST_NUMBER: idol.DEFAULT_CHEKISTS_NINETEENTH_POST,
            post.CHEKISTS_TWENTIETH_POST_NUMBER: idol.DEFAULT_CHEKISTS_TWENTIETH_POST,
            post.CHEKISTS_TWENTY_FIRST_POST_NUMBER: idol.DEFAULT_CHEKISTS_TWENTY_FIRST_POST,
            post.CHEKISTS_TWENTY_SECOND_POST_NUMBER: idol.DEFAULT_CHEKISTS_TWENTY_SECOND_POST,
            post.CHEKISTS_TWENTY_THIRD_POST_NUMBER: idol.DEFAULT_CHEKISTS_TWENTY_THIRD_POST,
            ...
            post.CHEKISTS_TWENTY_SEVENTH_POST_NUMBER: child.DEFAULT_CHEKISTS_TWENTY_SEVENTH_POST,
            ...
            post.CHEKISTS_THIRTY_FIRST_POST_NUMBER: library.DEFAULT_CHEKISTS_THIRTY_FIRST_POST,
            post.CHEKISTS_THIRTY_SECOND_POST_NUMBER: library.DEFAULT_CHEKISTS_THIRTY_SECOND_POST,
            post.CHEKISTS_THIRTY_THIRD_POST_NUMBER: library.DEFAULT_CHEKISTS_THIRTY_THIRD_POST,
            post.CHEKISTS_THIRTY_FOURTH_POST_NUMBER: library.DEFAULT_CHEKISTS_THIRTY_FOURTH_POST,
            post.CHEKISTS_THIRTY_FIFTH_POST_NUMBER: final.DEFAULT_CHEKISTS_THIRTY_FIFTH_POST,
        }
