...
from src.payments.yookassa_response_parser import YooKassaResponseParser
...
class YooKassaPaymentGateway(PaymentGateway):
    ...
    def __init__(self, settings: YooKassaSettings) -> None:
        ...
        self.__response_parser = YooKassaResponseParser()
    ...
    async def __create_payment(self, user_id: int, guide: str, description: str, price: str):
        ...
        return self.__response_parser.parse_confirmation_payment(result)
