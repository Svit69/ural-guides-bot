...
class ChekistsCallbackRegistrar:
    def register_callbacks(self, dispatcher: Dispatcher, handler: object) -> None:
        pairs = (
            ...
            (handler._send_chekists_twenty_ninth_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_TWENTY_EIGHTH),
            (handler._send_chekists_thirtieth_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_TWENTY_NINTH),
            (handler._send_chekists_thirty_first_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_THIRTIETH),
            (handler._send_chekists_thirty_second_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_THIRTY_FIRST),
            (handler._send_chekists_thirty_third_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_THIRTY_SECOND),
            (handler._send_chekists_thirty_fourth_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_THIRTY_THIRD),
            (handler._send_chekists_thirty_fifth_post, GuideCallbackData.CHEKISTS_NEXT_AFTER_THIRTY_FOURTH),
        )
